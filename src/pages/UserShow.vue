<template>
  ...
  <van-cell :value="user.uid" icon="comment-o">
      <template #title>
...
onMounted(async () => {
  ...
  console.log("好友"+user.value.id+"信息=",JSON.stringify(user.value))
  imageList.value  = await fetchGenshinData();
  console.log("imageList.value: ", JSON.stringify(imageList.value));
